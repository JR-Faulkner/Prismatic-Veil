...
Each hero card also carries an RP bar and a 3-facet Attunement gauge (rotated-45° diamonds, lighting facet *i* once `attunement > i`, turning gold when all three are lit — VEILSHIFT ready) — the same HP/RP/Attunement resource architecture BP's own HUD now shows during a linked round.
