(()=>{
  ...
  .hotspot:hover,.hotspot:focus-visible{filter:drop-shadow(0 0 14px #9d6cff99) brightness(1.1)}
  button:not(.pv-music-toggle){border-color:#c9aa6288!important;box-shadow:inset 0 0 0 1px #ffffff09,0 5px 16px #0007}
  button:not(.pv-music-toggle):focus-visible{outline:2px solid var(--pv-cyan)!important;outline-offset:2px!important;box-shadow:0 0 20px #8d5cff66!important}
