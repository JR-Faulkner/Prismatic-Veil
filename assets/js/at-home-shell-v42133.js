...
const FALLBACK_BUILD='v4.21.33';
const ART='./assets/ui/at-mock1/at_splash_mock1_982x2129.webp?v=v4.21.33';
...
document.getElementById('newGame').onclick=()=>{
  localStorage.removeItem(SAVE);
  launch('./at-game-v42133.html?new=1&v='+encodeURIComponent(BUILD));
};
continueBtn.onclick=()=>launch('./at-game-v42133.html?continue=1&v='+encodeURIComponent(BUILD));
