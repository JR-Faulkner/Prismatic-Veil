...
const FALLBACK_BUILD='v4.21.5';
const ART='./assets/ui/at-mock1/at_splash_mock1_982x2129.webp?v=v4.21.5';
...
document.getElementById('newGame').onclick=()=>{
  localStorage.removeItem(SAVE);
  launch('./at-game-v4215.html?new=1&v='+encodeURIComponent(BUILD));
};
continueBtn.onclick=()=>launch('./at-game-v4215.html?continue=1&v='+encodeURIComponent(BUILD));
