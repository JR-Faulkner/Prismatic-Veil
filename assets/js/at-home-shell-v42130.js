...
const FALLBACK_BUILD='v4.21.30';
const ART='./assets/ui/at-mock1/at_splash_mock1_982x2129.webp?v=v4.21.30';
...
document.getElementById('newGame').onclick=()=>{
  localStorage.removeItem(SAVE);
  launch('./at-game-v42130.html?new=1&v='+encodeURIComponent(BUILD));
};
continueBtn.onclick=()=>launch('./at-game-v42130.html?continue=1&v='+encodeURIComponent(BUILD));
