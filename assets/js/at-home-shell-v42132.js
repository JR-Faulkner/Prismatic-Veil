...
const FALLBACK_BUILD='v4.21.32';
const ART='./assets/ui/at-mock1/at_splash_mock1_982x2129.webp?v=v4.21.32';
...
.actions{position:absolute;left:50%;top:auto;bottom:14.8%;transform:translateX(-50%);width:min(82vw,372px);display:grid;gap:10px}
...
.saveNote{position:absolute;left:50%;top:auto;bottom:8.3%;transform:translateX(-50%);width:86vw;margin:0;text-align:center;color:#b7cbce;font:800 8px/1.35 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.08em;text-shadow:0 2px 4px #000}
...
@media(max-width:430px){.actions{top:auto;bottom:14.2%;width:min(84vw,350px);gap:9px}.launch{height:52px;font-size:11px}.saveNote{top:auto;bottom:7.6%}}
@media(max-height:720px){.actions{top:auto;bottom:12.2%;gap:7px}.launch{height:47px}.saveNote{top:auto;bottom:5.8%}}
...
let BUILD=window.__AT_LIVE_BUILD||FALLBACK_BUILD;localStorage.setItem('at.liveBuild',BUILD);
...
document.getElementById('newGame').onclick=()=>{
  localStorage.removeItem(SAVE);
  launch('./at-game-v42132.html?new=1&v='+encodeURIComponent(BUILD));
};
continueBtn.onclick=()=>launch('./at-game-v42132.html?continue=1&v='+encodeURIComponent(BUILD));

if(window.__AT_LIVE_BUILD)setBuild(window.__AT_LIVE_BUILD);
})();